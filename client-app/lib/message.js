  ...
  static okMessage (msg) {
    toast.custom((t) => (
      <div
        ...
        } relative overflow-hidden max-w-md w-full bg-white shadow-lg rounded-lg pointer-events-auto flex ring-1 ring-black ring-opacity-5`}
      >
        ...
        <div className='absolute w-full h-1 bg-green-600 bottom-0 animate-slide -translate-x-full'></div>
      </div>
    ))
  }
  ...
  static errorMessage (msg) {
    toast.custom((t) => (
      ...
      >
        <div className="flex-1 w-0 p-5">
          <div className='flex flex-row gap-4 items-center'>
            ...
            <div className="h-full w-auto border-l border-gray-200 pl-5">
              ...
              <p className='text-sm font-light text-gray-500'>
                Hubo un problema al momento de ejecutar su petición, por favor intentelo más tarde
              </p>
            </div>
          </div>
        </div>
        ...
        <div className='absolute w-full h-1 bg-red-600 bottom-0 animate-slide'>
        </div>
      </div>
    ))
  }
  ...
  static warningMessage (msg) {
    toast.custom((t) => (
      ...
      >
        ...
        <div className='absolute w-full h-1 bg-yellow-500 bottom-0 animate-slide'>
        </div>
      </div>
    ))
  }
