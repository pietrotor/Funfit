import { Chip, Image, Switch, useDisclosure } from '@nextui-org/react'
...
function ProductOnBranch() {
  ...
  return (
    <AdministrationLayout showBackButton={true}>
      <div className="m-auto w-5/6 mt-7 space-y-7">
        <h3 className="text-center text-4xl font-extrabold text-gray-500 ">
          Administración de productos
        </h3>
        <div className="flex w-full items-center">
          <div className="lg:flex lg:w-1/5 lg:justify-center hidden">
            <Image
          ...
          <div className="min-h-36 lg:w-4/5 w-full">
            <InformationCard className="h-full rounded-3xl border-2 border-primary/60">
              <section className="flex flex-col space-y-3 p-2 px-6">
                <div className="flex items-center justify-between">
                  <h2 className="text-left lg:text-4xl font-extrabold text-primary">
                    {branchInfo?.name}
                  </h2>
                  ...
                  <div className="flex flex-col">
                    ...
                    Habilitado para ventas: {'  '}
                      <Switch
                        size="sm"
                        className="text-xs"
                        isSelected={isAviable}
                        onChange={() => setIsAviable(!isAviable)}
                      >
                      </Switch>
                    </p>
                  </div>
            ...
            (productBranch, idx) => ({
              content: [
                ...
                <Switch
                  ...
                  onChange={() => handleSwitchChange(productBranch as TProductBranchData, 'web')}
                >
