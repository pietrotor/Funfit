...
const Pagination = ({
  ...
  //   plus: number = 1
  // ) => ({
  //   value: ((idx + plus) * multiplicator).toString(),
  //   label: ((idx + plus) * multiplicator).toString()
  // })

  // const pageOptions = Array.from(Array(totalPages), (_, i) =>
  //   optionsConstructor(i, _, _)
  // )
  // const itemsPerPageOptions = Array.from(Array(10), (_, i) =>
  //   optionsConstructor(i, 10, _)
  // )
